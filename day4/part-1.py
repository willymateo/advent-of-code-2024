...
diagonals_str_arr = np.array(["".join(diagonal) for diagonal in diagonals])
diagonals_inverted = get_top_left_to_bottom_right_diagonals(word_search_matrix.T)
diagonals_inverted_str_arr = np.array(
    ["".join(diagonal) for diagonal in diagonals_inverted]
)
...
vertical_founds = np.strings.count(lines_arr, "XMAS")
...
diagonals_found = np.strings.count(diagonals_str_arr, "XMAS")
diagonals_found_total = np.sum(diagonals_found)
diagonals_inverted_found = np.strings.count(diagonals_inverted_str_arr, "SAMX")
diagonals_inverted_found_total = np.sum(diagonals_inverted_found)
...
total_founds = (
    ...
    + diagonals_found_total
    + diagonals_inverted_found_total
)
